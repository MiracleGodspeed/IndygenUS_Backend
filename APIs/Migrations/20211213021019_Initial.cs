...
namespace APIs.Migrations
{
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //        ComplianceText = table.Column<string>(type: "nvarchar(max)", nullable: true),
            //        Active = table.Column<bool>(type: "bit", nullable: false)
            //    },
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_COMPLIANCE_TYPE", x => x.Id);
            //    });
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_SEXUAL_ORIENTATION", x => x.Id);
            //    });
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_USER_COMPLIANCE", x => x.Id);
            //        table.ForeignKey(
            //            name: "FK_USER_COMPLIANCE_COMPLIANCE_TYPE_ComplianceTypeId",
            //            column: x => x.ComplianceTypeId,
            //            principalTable: "COMPLIANCE_TYPE",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            //            name: "FK_USER_COMPLIANCE_USER_UserId",
            //            column: x => x.UserId,
            //            principalTable: "USER",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Restrict);
            ...
            //        MemberBlackCommunityId = table.Column<int>(type: "int", nullable: true),
            //        ArmedForceVeteranId = table.Column<int>(type: "int", nullable: true)
            //    },
            //    constraints: table =>
            //    {
            ...
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            //            name: "FK_USER_FRINGE_DETAILS_RESPONSE_TYPE_ArmedForceVeteranId",
            //            column: x => x.ArmedForceVeteranId,
            ...
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            //            name: "FK_USER_FRINGE_DETAILS_RESPONSE_TYPE_MemberBlackCommunityId",
            //            column: x => x.MemberBlackCommunityId,
            //            principalTable: "RESPONSE_TYPE",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            ...
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            //            name: "FK_USER_FRINGE_DETAILS_SEXUAL_ORIENTATION_SexualOrientationId",
            //            column: x => x.SexualOrientationId,
            //            principalTable: "SEXUAL_ORIENTATION",
            //            principalColumn: "Id",
            //            onDelete: ReferentialAction.Restrict);
            //        table.ForeignKey(
            ...
            //    constraints: table =>
            //    {
            //        table.PrimaryKey("PK_SURVEY_QUESTION_SUB_OPTIONS", x => x.Id);
            //        table.ForeignKey(
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_USER_COMPLIANCE_ComplianceTypeId",
            //    table: "USER_COMPLIANCE",
            //    column: "ComplianceTypeId");

            //migrationBuilder.CreateIndex(
            //    name: "IX_USER_COMPLIANCE_UserId",
            //    table: "USER_COMPLIANCE",
            //    column: "UserId");
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_USER_FRINGE_DETAILS_ArmedForceVeteranId",
            //    table: "USER_FRINGE_DETAILS",
            //    column: "ArmedForceVeteranId");
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_USER_FRINGE_DETAILS_MemberBlackCommunityId",
            //    table: "USER_FRINGE_DETAILS",
            //    column: "MemberBlackCommunityId");
            ...
            //migrationBuilder.CreateIndex(
            //    name: "IX_USER_FRINGE_DETAILS_SexualOrientationId",
            //    table: "USER_FRINGE_DETAILS",
